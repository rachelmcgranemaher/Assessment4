						...
						<tbody>
							<c:forEach var="user" items="${products }">
								<tr>
									...
									<td>${product.photo}</td>
									<td>${product.price}</td>
									<td><a href="/delete-product?id=${product.id }"><input type="submit" class="btn btn-primary" value="delete" /></a></td>
									<td><a href="/edit-product?id=${product.id }"><input type="submit" class="btn btn-primary" value="edit" /></a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
